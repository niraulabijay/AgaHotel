          ...
          <div className="col-md-6">
            <div className="about-text">
              ...
              <div className="para">
                ...
                5-star treatment without spending a ridiculous amount of money.
                On top of that, we think you should be treated and taken care of
                like a family member. So, we started AGA Hotels with a mission
                of providing the best customer service at a very affordable
                rate. Our every staff member is trained to provide you with
                phenomenal customer service and treat you like a family member.
                Our rooms, dining area, pools, gyms are designed to provide 100%
            ...
            <div className="col-md-6">
              <div className="owner-wrap">
                ...
                <div className="description">
                  Our visionary and highly enthusiastic co-founder Armaan Patel
                  is committed to build a highly customer-centric Hotel
          ...
          <div className="row owner-wrapper2">
            ...
            <div className="col-md-6 order-md-0">
              <div className="owner-wrap">
                ...
                <div className="description">
                  Entrepreneurial minded co-founder Yash Desai has envisioned a
                  chain of hotels that will be loved by people for its supreme
                  customer service. He focuses on various aspects that will help
                  customers receive a 5-star service without breaking their
                  banks.
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-6">
            <div className="overview-content">
              ...
              <div className="description">
                ...
                standards in our rooms and food and beverage divisions. We
                provide a fair return on investment for our owners and
                recognise."
              </div>
            </div>
          </div>
