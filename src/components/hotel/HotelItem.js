          ...
          <div className="hotel-item" key={index}>
            <div className="d-flex justify-content-space-between">
              ...
              <div className="hotel-logo">
                <img src={hotelItem.brand.logo} className="img-fluid" alt="" />
              </div>
            </div>
            <div className="row">
                ...
                <div className="row">
                  <div className="col-md-7">
                    <div className="img-container">
                      <img src={hotelItem.image} className="img-fluid" alt="" />
                    </div>
                  </div>
              ...
              <div className="col-xl-2 price-wrapper-container">
                <div className="price-wrapper">
                  <div className="main-price">
                    USD{" "}
                    <strike>{parseFloat(hotelItem.lowest_price) + 10}</strike>
                  </div>
                  <div className="offer-price-container">
                    <div className="offer-price">
                      USD {hotelItem.lowest_price}
                    </div>
